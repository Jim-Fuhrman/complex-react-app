...
function HomeGuest() {
  ...
  async function handleSubmit(e) {
    e.preventDefault()
    try {
      await Axios.post("/register", { username, email, password }) //when the label and the value have the same name we can just type username instead of username: username. Same goes with email and password
